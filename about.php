...
<body>
    <section id="wrapper">
        ...
        <section class="main-col">
            <h2>About symblog</h2>
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora doloribus hic alias accusamus at consequuntur vitae sed sint neque totam sunt ea eligendi, quibusdam iusto molestias aliquam animi iure debitis.
            </p>
        </section>
        <aside class="sidebar">
